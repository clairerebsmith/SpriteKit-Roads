...
@objcMembers
class GameScene_3_0_1_1_0_0_0_0_0_0_0_0: SKScene, SKPhysicsContactDelegate {
    ...
    func createObstacle() {
        // create and position the mine
        let obstacle = SKSpriteNode(imageNamed: "enemy-mine")
    ...
    func playerHit(_ node: SKNode) {
        if node.name == "obstacle" {
            ...
            DispatchQueue.main.asyncAfter(deadline: .now() + 2) {
                ...
                if let scene = GameScene_3_0_1_1_0_0_0_0_0_0_0_x(fileNamed: "GameScene") {
