...
@objcMembers
class GameScene_4_0_2_0_0_0_1_0_1_0_0_0_x: SKScene {
    var cols = [[Item]]()
    ...
    override func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        run(SKAction.playSoundFileNamed("zap", waitForCompletion: false))
        movesRemaining -= 1
    ...
    func triggerSpecialItem(_ item: Item) {
        ...
        var itemImages = ["alien-blue", "alien-gray", "alien-green", "alien-pink", "alien-purple", "alien-yellow"]
        itemImages.shuffle()
    ...
    func endGame() {
        ...
        DispatchQueue.main.asyncAfter(deadline: .now() + 4) {
            ...
            if let scene = GameScene_4_0_2_0_0_0_1_0_1_0_0_0_x(fileNamed: "GameScene") {
