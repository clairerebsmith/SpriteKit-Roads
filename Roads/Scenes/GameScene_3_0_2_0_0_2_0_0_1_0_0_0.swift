...
@objcMembers
class GameScene_3_0_2_0_0_2_0_0_1_0_0_0: SKScene, SKPhysicsContactDelegate {
    ...
    func createObstacle() {
        // create and position the ground, choosing either high or low to make the player dodge them
        ...
        DispatchQueue.main.asyncAfter(deadline: .now() + 1.5) {
            ...
            coin.position.y = CGFloat.random(in: -170 ..< 170)
            coin.position.x = 768
            coin.name = "score"
            coin.run(action)
    ...
    func playerHit(_ node: SKNode) {
        if node.name == "obstacle" {
            ...
            DispatchQueue.main.asyncAfter(deadline: .now() + 2) {
                ...
                if let scene = GameScene_3_0_2_0_0_2_0_0_1_0_0_x(fileNamed: "GameScene") {
