...
@objcMembers
class GameScene_4_0_0_0_0_0_1_0_0_0_0_0_0: SKScene {
    var cols = [[Item]]()
    ...
    func triggerSpecialItem(_ item: Item) {
        ...
        var itemImages = ["shape-circle", "shape-diamond", "shape-heart", "shape-pentagon", "shape-square", "shape-star", "shape-triangle"]
        itemImages.shuffle()
    ...
    func endGame() {
        ...
        DispatchQueue.main.asyncAfter(deadline: .now() + 4) {
            ...
            if let scene = GameScene_4_0_0_0_0_0_1_0_0_0_0_0_x(fileNamed: "GameScene") {
